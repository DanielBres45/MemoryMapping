...
use memory_math::{memory_extents2d::MemExtents2D, memory_index2d::MemIndex2D};
...
pub trait Vector2D<T: Sized> {
    ...
    fn new_from_flatpack(flatpack: Vec<T>, width: usize, height: usize) -> Result<Self, String>
    where
        Self: Sized,
    {
